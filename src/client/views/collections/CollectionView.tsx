...
export class CollectionView extends Touchable<FieldViewProps> {
    ...
    private SubViewHelper = (type: CollectionViewType, renderProps: CollectionRenderProps) => {
        ...
        switch (type) {
            ...
            case CollectionViewType.Timeline: return <CollectionTimelineView CollectionView={this} chromeCollapsed={this._collapsed} key="collview" ChromeHeight={this.chromeHeight} {...props} />;
