...
export class MainOverlayTextBox extends React.Component<MainOverlayTextBoxProps> {
    ...
    private _outerdiv: React.RefObject<HTMLDivElement>;
    ...
    render() {
        ...
        if (FormattedTextBox.InputBoxOverlay && this._textTargetDiv) {
            ...
            return <div ref={this._outerdiv} className="unscaled_div"><div className="mainOverlayTextBox-textInput" style={{ transform: `translate(${textRect.left}px, ${location}px) scale(${1 / s},${1 / s})`, width: "auto", height: "0px" }} >
